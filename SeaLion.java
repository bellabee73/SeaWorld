...
public class SeaLion extends Animal
{
    ...
    private static final int SEALION_FOOD_VALUE = 9;
    ...
    public SeaLion(boolean randomAge, Field field, Location location)
    {
        ...
        if(randomAge) {
            ...
            foodLevel = rand.nextInt(SEALION_FOOD_VALUE);
        }
        else {
            age = 0;
            foodLevel = SEALION_FOOD_VALUE;
        }
    }
     ...
     */
    public void act(List<Animal> newSeaLions)
    {
        incrementAge();
        incrementHunger();
        if(isAlive()) {
     ...
     * @param newFoxes A list to return newly born foxes.
     */
    private void giveBirth(List<Animal> newSeaLions)
    {
